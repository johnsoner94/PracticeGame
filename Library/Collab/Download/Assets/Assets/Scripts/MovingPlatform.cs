...
public class MovingPlatform : MonoBehaviour {
	/* This script controls a platform gameobject that 
	 * moves between a start and ending point. The player
	 * is able to simple stand on the object and 
	 * the player will move along with it. */
